...
CONFIG_VARS="LOCALSTACK_PORT LOCALSTACK_NAME OBJECT_STORAGE_REGION BATCH_UPLOADS_BUCKET IMAGES_BUCKET TRACKS_BUCKET UPLOAD_QUEUE GATEWAY_URL ADMIN_USER ADMIN_PASSWORD CLUSTER CONTEXT NODE KEYCLOAK_REALM KEYCLOAK_ADMIN KEYCLOAK_ADMIN_PASSWORD KEYCLOAK_TEST_USER KEYCLOAK_TEST_PASSWORD KEYCLOAK_INTERNAL_URL WALLET_APP_DB WALLET_IMAGES_BUCKET KEYCLOAK_WALLET_CLIENT_ID KEYCLOAK_WALLET_CLIENT_SECRET WALLET_API_KEY"
expand_vars() {
  local s="$1" v
